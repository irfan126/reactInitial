          ...
          <div className='upper-section'>
            <div className='row'>
              ...
              <Carousel showArrows={true} showThumbs={false} autoPlay={false}>
                <div>
                    {(rental.image1 === 'none') && <img className="img-fluid" alt='imageNone' src={'https://s3.eu-west-2.amazonaws.com/bwm-image-dev/1553036875365'}/>}       
                    {!(rental.image1 === 'none') && <img className="img-fluid"  alt='image1' src={rental.image1}/> }
                </div>
                <div>
